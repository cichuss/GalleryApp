...
import com.example.galleryapp.data.PhotoResponse
import com.example.galleryapp.data.PhotosMetaData
...
class ApiServiceTest {
    ...
    fun fetchPhotosSearchResponse_returnsResponse() = runBlocking {
        ...
        assertTrue("Response should be of PhotosSearchResponse type", response is PhotosSearchResponse)
